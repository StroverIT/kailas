...
const spaces = [
  ...
  },
  {
    ...
    description:
      "11 професионални люлки за практикуващи. Предоставяме пространството – ти избираш свой инструктор или практикуваш самостоятелно. Декомпресия на гръбнака и дълбока релаксация над земята.",
  },
  {
