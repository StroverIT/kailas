      ...
      <div className="container mx-auto max-w-2xl">
        <div ref={headerRef} className="text-center mb-12">
          ...
          <p className="section-subheading mx-auto">
            За кратко или по-дълго сте добре дошли – за да се върнете към себе
            си, да преосмислите пътя си и да продължите напред. Попълни формата
            и ще се свържем с теб.
          </p>
        </div>
