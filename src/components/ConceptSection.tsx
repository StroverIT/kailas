      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16 relative">
          ...
          <ScrollReveal delay={0.2}>
            <p className="section-subheading mx-auto">
              ...
              панорамна гледка към изгрева и равнината. Замислен и построен през
              2010 година първоначално като място за ведически практики с огън и
        ...
        <div ref={missionRef} className="mt-16 text-center opacity-0">
          ...
          <blockquote className="font-heading text-xl md:text-2xl italic text-foreground/80 max-w-3xl mx-auto leading-relaxed">
            ...
            йога център, за да се върнете към себе си, да преосмислите пътя си и
