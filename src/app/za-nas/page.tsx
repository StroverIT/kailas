  ...
  return (
    <div className="min-h-screen">
      ...
      >
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-muted-foreground font-body text-lg leading-relaxed max-w-2xl mx-auto">
            Вдъхновени от опита да трансформираме живота и желанието да споделим
            този опит и натрупаните познания с всички, които искат да поемат пътя
            на себеопознаване и личностна промяна.
          </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-background">
        <div ref={introRef} className="container mx-auto max-w-4xl">
          <p className="text-muted-foreground font-body leading-relaxed text-lg mb-8">
            ...
            трансформира живота си и желанието да сподели този опит и натрупаните
            познания и умения с всички желаещи да поемат пътя на себеопознаване и
            личностна промяна, за да внесат в живота си здраве на всички нива,
            радост и удовлетвореност.
          </p>
          <p className="text-muted-foreground font-body leading-relaxed text-lg">
            ...
            проявленията си, да хармонизираме ума си, да подобряваме комуникацията
            си със самите нас и света наоколо.
          </p>
        </div>
      </section>
        ...
        <div ref={missionRef} className="container mx-auto max-w-4xl">
          ...
          <blockquote className="border-l-4 border-secondary/50 pl-6 py-4">
            <p className="text-lg md:text-xl text-muted-foreground font-body italic leading-relaxed">
              Нашата мисия е да предоставим пространство, опит, споделеност и
              подкрепа, за да извървим пътя, чрез който да преоткрием богатството
              на йога и духовното наследство на човечеството – за по-добър и
              щастлив живот.
            </p>
          </blockquote>
        </div>
        ...
        <div ref={founderRef} className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6 text-muted-foreground font-body leading-relaxed">
            ...
            <p>
              ...
              стремяла в целия си житейски път. И пътят, познанието, практиките и
              мъдростта на йога станаха мое ежедневно вдъхновение и начин на
              живот.
            </p>
            <p>
              ...
              изпълнен с усмивка, добро настроение и радост. Благодарение на йога
              се оздравих, станах по-жизнена и по-енергична, по-спокойна и
            ...
            <p>
              ...
              мантра джапа и медитация, киртан, карма йога, сева йога, раджа йога,
              бакти йога, сатсанг – докосване до мъдростта на духовните учители на
              света и древните ведически знания.
            </p>
            <p>
              В периода от 2007 до днес, паралелно с ежедневните практики по
              хатха и раджа йога, преминах през множество обучения у нас, в Индия
              и Европа, сред които – крия йога по системата на Свами Сатянанда,
              мантра и хаван, свара йога, теоретични и практически занимания
              свързани с някои философски аспекти на познанието, практикум по
              Саундаря Лахари под ръководството на Свами Сатясангананда.
            </p>
            <p>
              ...
              сертифициран преподавател по йога от Международния Йога Алианс. Имах
              щастието да завърша и шест месечен курс за преподаватели по
              медитация, воден от един от най-квалифицираните учители с
              международно признание Свами Ведантананда, която преподава на учители
              по йога от цял свят повече от 20 години. Продължавам да практикувам
              и уча задълбочено, и да навлизам все по-навътре в необятния свят на
              йога – науката за живота.
            </p>
            <p>
              Преподавам йога в светлината на философията на йогийската наука и
              ведическото познание. Практиките са съчетание на хатха йога, мантра,
              релаксация и медитация, работа с дъха и праните. В нашите занимания
              се запознаваме и мъдростта на ведите и упанишадите, древните
              йогически текстове и преките препоръки на учителите. Насочени са към
              цялостно хармонизиране и постигане на баланс на всички нива на
              човека.
            </p>
            <p>
              Междувременно, в годините, израстна и се реализира идеята да създам
              център за йога като начин на живот – Йога център „Кайлас" на
              територията на Природен парк „Врачански Балкан", където всеки, който
              желае, да може да усвои йога като практика на ежедневието и начин на
              живот. С благословията на Свами Ниранджанананда – Гуру на Бихарската
              школа по йога и незаменим учител и вдъхновител за мен, този център
              действа от 2020-та година и продължава да се развива и оформя облика
              си с подкрепата на моето семейство, приятели и съмишленици.
            </p>
            <p>
              Ако и вие искате да надзърнете в света на йога, да преоткриете
              силата и енергията си, да опознаете себе си, да се оздравите, да се
              радвате повече на ежедневието си и света, в който живеете,
              заповядайте при нас!
            </p>
          </div>
      ...
      <section className="section-padding bg-gradient-section">
        <div ref={valuesRef} className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-muted-foreground font-body mb-8 max-w-xl mx-auto">
            Разгледайте нашите практики, прочетете за различните видове йога и се
            запишете за следващото събитие.
          </p>
